...
declare module 'react' {
  interface CSSProperties {
    ...
    '--glowingeffect-border-width'?: string | number;
    '--repeating-conic-gradient-times'?: string | number;
    '--gradient'?: string;
  }
}
      ...
      <>
        ...
        <div
          className={cn(
            ...
            disabled ? "opacity-100 block" : "opacity-0 hidden",
        ...
        <div
          ...
          className={cn(
            ...
            disabled ? "opacity-0 hidden" : "opacity-100 block",
